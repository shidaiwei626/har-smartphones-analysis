...
The purpose of this project is to download and clean the dataset from UCI "Human Activity Recognition Using Smartphones", and prepare tidy data that can be used for later analysis.

All the functions created for this project is in the ***[run_analysis.R](./run_analysis.R)*** file, and the demonstration of how you can use it is in the ***[CodeBook.md](./CodeBook.md)*** file.


## Appendix I - How the Dataset was Collected
...
## Appendix II - Getting and Cleaning Data Course Project
